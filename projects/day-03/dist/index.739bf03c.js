...
(0, _utils.preloadFonts)("lwc3axy").then(()=>document.body.classList.remove("loading"));
// Call the splittingjs to transform the data-splitting texts to spans of chars
(0, _splittingDefault.default)();
// Custom cursor
new (0, _cursorDefault.default)(document.querySelector(".cursor"));
// DOM elements
let DOM = {
    content: {
        home: {
...
},{"splitting/dist/splitting.css":"3uR7n","splitting/dist/splitting-cells.css":"7jeGL","splitting":"77jB6","gsap":"fPSuC","./utils":"72Dku","./cursor":"3v1v0","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3uR7n":[function() {},{}],"7jeGL":[function() {},{}],"77jB6":[function(require,module,exports) {
...
window.addEventListener("mousemove", (event)=>mouse = (0, _utils.getMousePosition)(event));
class Cursor {
    constructor(el){
        this.DOM = {
            el: el
        ...
        this.onMouseMoveEv = ()=>{
            ...
            (0, _gsapDefault.default).to(this.DOM.el, {
                duration: 0.9,
                ease: "Power3.easeOut",
                opacity: 1
            });
...
},{"gsap":"fPSuC","./utils":"72Dku","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["cVgJb","ebWYT"], "ebWYT", "parcelRequire42cf")
