...
},{"@studio-freight/lenis":"jOD5W","gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./utils":"72Dku"}],"jOD5W":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
var r = /*#__PURE__*/ function(t) {
    var r, e;
    function l(i) {
        var r, e, l, n, s = void 0 === i ? {} : i, c = s.lerp, d = void 0 === c ? .1 : c, h = s.smooth, a = void 0 === h || h, u = s.direction, v = void 0 === u ? "vertical" : u;
        (n = t.call(this) || this).onResize = function(t) {
            var o = t[0];
            if (o) {
                var i = o.contentRect;
                n.limit = "horizontal" === n.direction ? i.width - n.windowWidth : i.height - n.windowHeight;
            }
        }, n.onWindowResize = function() {
            n.windowHeight = window.innerHeight, n.windowWidth = window.innerWidth;
        }, n.onVirtualScroll = function(t) {
            var o = t.deltaY, i = t.originalEvent;
            n.stopped ? i.preventDefault() : (n.smooth && !i.ctrlKey && i.preventDefault(), n.targetScroll -= o, n.targetScroll = Math.max(0, Math.min(n.targetScroll, n.limit)));
        ...
        }, n.lerp = d, n.smooth = a, n.direction = v, window.addEventListener("scroll", n.onScroll, !1), window.addEventListener("resize", n.onWindowResize, !1);
        var f = (null == (r = navigator) || null == (e = r.userAgentData) ? void 0 : e.platform) || (null == (l = navigator) ? void 0 : l.platform) || "unknown";
        return n.virtualScroll = new (0, _virtualScrollDefault.default)({
            firefoxMultiplier: 50,
            mouseMultiplier: f.indexOf("Win") > -1 ? 1 : .4,
            useKeyboard: !1,
            useTouch: !1,
            passive: !1
    ...
    e = t, (r = l).prototype = Object.create(e.prototype), r.prototype.constructor = r, i(r, e);
    var n = l.prototype;
    return n.start = function() {
        ...
        var i, r = void 0 === o ? {} : o, e = r.offset, l = void 0 === e ? 0 : e, n = r.immediate, s = void 0 !== n && n;
        if ("number" == typeof t) i = t;
            ...
            i = ("horizontal" === this.direction ? d.left : d.top) + this.scroll;
        }
        this.targetScroll = i += l, this.scrolling = !0, this.smooth && !s || (this.scroll = i, "horizontal" === this.direction ? window.scrollTo(this.scroll, 0) : window.scrollTo(0, this.scroll));
    }, l;
...
},{}]},["cVgJb","ebWYT"], "ebWYT", "parcelRequire0167")
